...
import { Download, Printer, Calendar, TrendingDown, ShoppingBag } from 'lucide-react';
...
export const PurchaseReport = () => {
    ...
    const fetchReport = async () => {
        try {
            setLoading(true);
            const data = await reportService.getPurchaseReport(currentCompany.id, startDate, endDate);
            setReport(data);
        } catch (error) {
        ...
        return (
            <div className="flex items-center justify-center py-12">
                <div className="text-center">
                    ...
                    <p className="mt-4 text-gray-600 dark:text-gray-400">Loading purchase report...</p>
                </div>
            </div>
        );
    }
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm text-gray-500 dark:text-gray-400">Average Purchase</p>
                            <p className="text-2xl font-bold text-gray-900 dark:text-white">
